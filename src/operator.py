...
class Operator:
    ...
    def open_doors(self, num: int) -> None:
        if num < 0 or num >= len(self.elevators_list):
    ...
    def call_dispatcher(self, num: int) -> None:
        ...
        """
        try:
            self.elevators_list[num].call_dispatcher()
    ...
    def get_elevator_state(self, num: int) -> dict:
        ...
        """
        state = {
            "direction": self.elevators_list[num].current_direction,
    ...
    def restart(self, num: int) -> None:
        ...
        self.elevators_list[num].current_floor = 1
        ...
        self.elevators_list[num].is_doors_blocked = False
